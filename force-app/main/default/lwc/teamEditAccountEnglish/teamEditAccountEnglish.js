...
import { OMNIDEF } from './teamEditAccountEnglish_def.js';
import tmpl from './teamEditAccountEnglish.html';
import tmpl_nds from './teamEditAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class teamEditAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
