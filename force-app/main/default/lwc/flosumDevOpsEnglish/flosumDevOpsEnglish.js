...
import { OMNIDEF } from './flosumDevOpsEnglish_def.js';
import tmpl from './flosumDevOpsEnglish.html';
import tmpl_nds from './flosumDevOpsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class flosumDevOpsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
