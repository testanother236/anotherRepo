import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqOpportunityStatusDesktop extends FlexCardMixin(LightningElement){
              ...
              @track Label={CPQRequestPendingApproval:"Request Approval",
        CPQDelete:"Delete",
        CPQViewRecord:"View Record",
        CPQEdit:"Edit",
        CPQGenerateDocumentPDF:"Generate Document PDF",
        CPQPrintableView:"Printable View",
        CPQClone:"Clone",
        CPQNewMultisiteOrder:"New Multi-Site Order",
        CPQNewMultisiteQuote:"New Multi-Site Quote",
        CPQApplyDiscount:"Apply Discount"
        };
              pubsubEvent = [];
              customEvent = [];
