...
import { OMNIDEF } from './dcLwccheckoutEnglish_def.js';
import tmpl from './dcLwccheckoutEnglish.html';
import tmpl_nds from './dcLwccheckoutEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dcLwccheckoutEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
