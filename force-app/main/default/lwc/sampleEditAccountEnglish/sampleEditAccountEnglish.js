...
import { OMNIDEF } from './sampleEditAccountEnglish_def.js';
import tmpl from './sampleEditAccountEnglish.html';
import tmpl_nds from './sampleEditAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sampleEditAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
