...
import { OMNIDEF } from './contractAmendEnglish_def.js';
import tmpl from './contractAmendEnglish.html';
import tmpl_nds from './contractAmendEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class contractAmendEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
