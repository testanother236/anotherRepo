...
import { OMNIDEF } from './sampleUpdateAccountPrimaryContactEnglish_def.js';
import tmpl from './sampleUpdateAccountPrimaryContactEnglish.html';
import tmpl_nds from './sampleUpdateAccountPrimaryContactEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sampleUpdateAccountPrimaryContactEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
