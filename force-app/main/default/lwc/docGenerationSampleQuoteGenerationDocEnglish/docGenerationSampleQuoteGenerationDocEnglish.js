...
import { OMNIDEF } from './docGenerationSampleQuoteGenerationDocEnglish_def.js';
import tmpl from './docGenerationSampleQuoteGenerationDocEnglish.html';
import tmpl_nds from './docGenerationSampleQuoteGenerationDocEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenerationSampleQuoteGenerationDocEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
