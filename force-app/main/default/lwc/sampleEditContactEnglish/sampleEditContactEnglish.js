...
import { OMNIDEF } from './sampleEditContactEnglish_def.js';
import tmpl from './sampleEditContactEnglish.html';
import tmpl_nds from './sampleEditContactEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sampleEditContactEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
